...
//export const sideBarData: sideBarDataType[] = [
  //{ path: "/newsfeed/style1", icon: "Search", tooltipTittle: "Explore" },
  //{ path: "/event", icon: "Calendar", tooltipTittle: "Event & history" },
  //{ path: Href, icon: "User", tooltipTittle: "Groups" },
  //{ path: "/favourite/home", icon: "Star", tooltipTittle: "Featured" },
//];
...
export const closeFriendsData = [
  { id: 1, name: "Debora Ferrara", image: "1", message: ["demo1"] },
  { id: 2, name: "Dea Gelardi", image: "2", message: ["demo2"] },
];

export const recentChatsData = [
  { id: 3, name: "Recente uno", image: "3", message: ["demo1"] },
  { id: 4, name: "Recente due", image: "4", message: ["demo2"] },
  { id: 5, name: "Recente tre", image: "5", message: ["demo2"] },
  { id: 6, name: "Recente quattro", image: "6", message: ["demo2"] },
  { id: 7, name: "Recente cinque", image: "7", message: ["demo2"] },
];
