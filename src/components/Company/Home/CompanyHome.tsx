            ...
            <Col lg="7" className="order-lg-2">
              <div className="content-screen">
                <div className="main-screen">
                  <Image src={`${ImagePath}/company-landing/home-laptop.png`} height={320} width={487} alt="image" className="img-fluid blur-up wow zoomIn lazyloaded" style={{visibility: "visible",animationDelay: "0.2s",animationName: "zoomIn",}}/>
                </div>
