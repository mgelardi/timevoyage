            ...
            <ul className="blog-post">
              {numbers.map((data, index) => (
                <li key={index}>
                  <Media>
                    <a href={Href}>
                      <Image height={66.56} width={100} className="img-fluid blur-up blur-up lazyloaded" src={`${ImagePath}/blog/${data}.jpg`} alt="Generic placeholder image"/>
                    </a>
                    <Media bodyclassName="align-self-center">
                      <div>
